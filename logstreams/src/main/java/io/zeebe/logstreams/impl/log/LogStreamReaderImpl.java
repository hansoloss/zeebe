 ...
 *
 * <p>The implementation currently does not perform any copying, however it is a good candidate to
 * introduce further look-ahead to improve I/O performance which would necessarily require copying.
 */
